      ...
      {loading ? (
        ...
        <Card>
          <EmptyState
            ...
            description="Registra pacientes y ejecuta matching en un protocolo para poblar el Dashboard. Si ya cargaste pacientes en Supabase, ejecuta también la parte de screenings en seed.sql."
            action={
              <Link
