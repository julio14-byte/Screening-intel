      ...
      items: [
        {
          heading: "ETL clínico",
          body:
            "Extract (CSV, portal, PDF de laboratorio, foto de receta) → Transform (perfil, ICD-11, reglas) → Load (pacientes, screenings, re-match). No hay conector a EHR hospitalario.",
        },
        {
