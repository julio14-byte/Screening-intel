...
const server = new McpServer(
  ...
  {
    instructions:
      "Herramientas clínicas de pre-screening, matching y re-match en un clinical research site. Los resultados usan iniciales, no nombres completos. No cambian elegibilidad.",
  }
);
